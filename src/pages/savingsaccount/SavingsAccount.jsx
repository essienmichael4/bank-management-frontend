...
const SavingsAccount = () => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle : `${account?.firstname} ${account?.lastname} ${account?.othernames} Account Statement`
  })
  ...
  return (
    <>
      <PrintComponent  shownTransactions={shownTransactions} account={account} showPrintModal={showPrintModal} handleShowPrintModal={handleShowPrintModal}/>
      ...
      <div className='flex flex-col items-center md:items-start md:flex-row relative md:gap-4'>
        ...
        <div className={`${showTransaction && ''} py-4 transition w-full `}>
          ...
          <div
          ref={printRef}
          className='bg-white w-full border border-gray-300 px-4 pt-4 py-8 rounded-lg mt-4'>
            <div className='flex items-center justify-between py-2 mb-4'>
              ...
              <div className='flex items-center gap-2'>
                <button onClick={handleShowPrintModal} className={`text-sm flex whitespace-no-wrap items-center justify-center py-2 px-2`}>Print Statement</button>
                ...
                <button onClick={()=> handleFilters("all")} className={`${filters.all && 'active'} filter text-sm flex whitespace-no-wrap items-center justify-center py-2 px-2`}>All</button>
                  <button onClick={()=> handleFilters("deposite")} className={`${filters.deposite && 'active'} filter text-sm flex whitespace-no-wrap items-center justify-center py-2 px-2`}>Deposite</button>
                  <button onClick={()=> handleFilters("debit")} className={`${filters.debit && 'active'}  filter text-sm flex whitespace-no-wrap items-center justify-center py-2 px-2`}>Debit</button>
                </div>
